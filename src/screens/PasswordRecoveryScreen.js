...
import PasswordRecoveryForm from '../containers/auth/PasswordRecoveryForm';
		...
		<ScrollView style={{ flex: 1, backgroundColor: '#f3f3f3' }}>
			...
			<View style={styles.companyCardWrapper}>
				...
				<View style={styles.companyCard}>
					<Text style={styles.caption}>Забыли логин или пароль для входа? Отправьте заявку и наш менеджер свяжется с Вами для уточнения новых учетных данных.</Text>
